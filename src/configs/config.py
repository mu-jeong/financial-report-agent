...
DEPLOYMENT_ENVIRONMENT = get_config_value("DEPLOYMENT_ENVIRONMENT")
MONITORING_SUPABASE_URL = get_config_value("MONITORING_SUPABASE_URL")
MONITORING_SUPABASE_PUBLISHABLE_KEY = get_config_value(
    "MONITORING_SUPABASE_PUBLISHABLE_KEY"
)
MONITORING_OPERATOR_API_URL = get_config_value("MONITORING_OPERATOR_API_URL")
MONITORING_ARTIFACT_ROOT = get_config_value("MONITORING_ARTIFACT_ROOT")
...
VECTOR_RETRIEVAL_CONCURRENCY = get_config_value("VECTOR_RETRIEVAL_CONCURRENCY")
if VECTOR_RETRIEVAL_CONCURRENCY < 1:
    raise ValueError("VECTOR_RETRIEVAL_CONCURRENCY must be at least 1")
