    ...
    (
        ...
        (
            ...
            ConfigSpec(
                ...
                default="openrouter",
                parser=as_lower_str,
                description="Rerank provider: openrouter or flashrank fallback.",
                section="Rerank",
            ),
        ),
        (
        ...
        (
            ...
            ConfigSpec(
                ...
                default="LATEST",
                parser=as_str,
                description="LATEST uses the execution/target date as the search end date; SPECIFIC_DATE uses only target date logic.",
                section="Crawler",
            ),
        ),
        (
